...
# 최종점수 : 0.7357919516073437
# r2는  0.7357919516073437
# RMSE :  43.8455707415863
# 변형된 x_train :  (1062, 9) 변형된 x_test :  (266, 9)
# Thres=0.024, n= 9, R2: 73.58%
# 변형된 x_train :  (1062, 8) 변형된 x_test :  (266, 8)
# Thres=0.076, n= 8, R2: 68.81%
# 변형된 x_train :  (1062, 7) 변형된 x_test :  (266, 7)
# Thres=0.086, n= 7, R2: 71.68%
# 변형된 x_train :  (1062, 6) 변형된 x_test :  (266, 6)
# Thres=0.095, n= 6, R2: 70.66%
# 변형된 x_train :  (1062, 5) 변형된 x_test :  (266, 5)
# Thres=0.096, n= 5, R2: 73.67%
# 변형된 x_train :  (1062, 4) 변형된 x_test :  (266, 4)
# Thres=0.123, n= 4, R2: 70.60%
# 변형된 x_train :  (1062, 3) 변형된 x_test :  (266, 3)
# Thres=0.140, n= 3, R2: 72.05%
# 변형된 x_train :  (1062, 2) 변형된 x_test :  (266, 2)
# Thres=0.154, n= 2, R2: 62.41%
# 변형된 x_train :  (1062, 1) 변형된 x_test :  (266, 1)
# Thres=0.206, n= 1, R2: 63.26%