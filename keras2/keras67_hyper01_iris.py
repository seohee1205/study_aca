...
# 걸린시간 :  22.8822340965271
# model.best_params_ : {'optimizer': 'Adadelta', 'lr': 0.001, 'drop': 0.5, 'batch_size': 200, 'activation': 'relu'}
# model.best_estimator :  <keras.wrappers.scikit_learn.KerasClassifier object at 0x00000264476802E0>
# model.best_score_ :  0.8333333253860473
# model.score :  1.0
# acc :  1.0