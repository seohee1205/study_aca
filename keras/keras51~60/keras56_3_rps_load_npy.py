...
from tensorflow.keras.layers import Dense, MaxPooling2D, Conv2D, Flatten, LeakyReLU
...
model = Sequential()
model.add(Conv2D(256, (2,2), input_shape= (150, 150, 3), activation= 'relu'))
...
# loss :  [0.0030999998562037945, 0.9980158805847168]
