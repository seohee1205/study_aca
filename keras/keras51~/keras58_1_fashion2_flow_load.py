...
x_train = np.load(save_path + 'keras58_1_fashion_x_train.npy')
x_test = np.load(save_path + 'keras58_1_fashion_x_test.npy')
y_train = np.load(save_path + 'keras58_1_fashion_y_train.npy')
y_test = np.load(save_path + 'keras58_1_fashion_y_test.npy')
...
# loss :  [0.25695931911468506, 0.9089999794960022]
# acc :  0.909