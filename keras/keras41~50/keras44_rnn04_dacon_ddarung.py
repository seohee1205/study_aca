...
from tensorflow.python.keras.layers import Dense, GRU, Flatten, Input, Dropout, MaxPooling2D
import numpy as np
import pandas as pd
...
path_save = './_save/ddarung/'
submission.to_csv(path_save + 'submit_0323_1056.csv')
print('걸린 시간 : ', np.round(end-start, 2))


# result :  1660.843994140625
# r2 스코어 :  0.7488791692161648
