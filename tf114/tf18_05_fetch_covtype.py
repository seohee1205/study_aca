...
#1-3 onehotencoding
print(np.unique(y_data))  # [1 2 3 4 5 6 7]
...
w = tf.Variable(tf.random_normal([54, 7]), name = 'weight')
b = tf.Variable(tf.zeros([1, 7]), name = 'bias')  #[3]/ [1,3] 통상 모두 가능 
